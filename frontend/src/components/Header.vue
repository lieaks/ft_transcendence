...
<template>
	<header class="p-2 my-2 mb-4 text-white grid grid-flow-col justify-stretch items-center w-full">
		...
		<RouterLink class="text-2xl p-2 inline-flex justify-end ml-auto mr-0" to="/account">
			<img src="" alt="avatar">
			<h5 class="mx-2">account</h5>
		</RouterLink>
	</header>
</template>
